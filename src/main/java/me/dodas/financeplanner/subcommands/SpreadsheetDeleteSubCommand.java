...
public class SpreadsheetDeleteSubCommand implements SubCommand {

    private String name = "delete";
    private String description = "Delete a spreadsheet.";
    private Options options = new Options();

    public SpreadsheetDeleteSubCommand() {
        options.addOption(
            "h", 
            "help", 
            false, 
    ...
    public void executeCommand(List<String> args) {
        ...
        try {
            ...
            SpreadsheetManager.getInstance().deleteSpreadsheet(spreadsheetName);
